  ...
  return (
    <section ref={containerRef} className="w-full relative h-[400vh]">
      ...
      <div className="sticky top-0 w-full h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* The Expanding Viewport - Upgraded for Performance (No heavy blurs/shadows) */}
        <motion.div 
          style={{ height: viewportHeight }}
          className="w-[95%] max-w-7xl relative rounded-[2px] border-t border-b border-[var(--color-aurora)] bg-[var(--color-void)] overflow-hidden flex flex-col ring-1 ring-white/5 ring-inset will-change-[height]"
        >
          ...
          <motion.div 
            ...
            className="absolute inset-y-0 left-0 flex items-center px-12 pt-[140px] pb-12 gap-8 z-10 w-max will-change-transform"
          >
              ...
              >
                ...
                <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-between">
                  <div className="flex justify-between items-start w-full">
                    <span className="font-[var(--font-mono)] text-[10px] uppercase tracking-[0.2em] text-[var(--color-gold)] bg-black/80 px-3 py-1 border border-[var(--color-gold)]/30">
